...
---
# <a name="release-notes-for-build-17692"></a>빌드 17692에 대 한 릴리스 정보
_빌드 번호 17692. 6 월 2018._
...
* Hummingboard를 사용 하 여 온 보 딩이 실패 합니다.
* Up2 부팅에 실패 합니다.
...
`bcdedit /set debug off`제외. Windows 장치 포털/프로세스/실행 명령 "c:\windows\system32\bcdedit/set debug off")
