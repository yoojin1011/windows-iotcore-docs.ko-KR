...
---
# <a name="release-notes-for-build-16257"></a>빌드 16257에 대 한 릴리스 정보

_빌드 번호 16257. 8 월 2017_
...
* 일반 버그 수정 
* Cortana에서 음성 인식을 사용할 수 없도록 차단 된 버그 수정
...
* 암호 없이 WIFI AP를 만드는 기능 사용
* 하드웨어 키워드 검색 (HWKWS)을 사용 하도록 설정 합니다. 
...
* 그래픽 드라이버 문제로 인해 30-60 분 후에 joule이 불안정 해질 수 있습니다. 
* InstallOemCerts 명령 오류 (13038321)로 인해 이미지를 만들 수 없습니다. 
* 백그라운드 작업은 Windows 장치 포털의 앱 관리자 보기 (WDP) (13037606)에 표시 되지 않습니다. 
...
### <a name="for-joule"></a>Joule의 경우 
#### <a name="firmware-update-required"></a>펌웨어 업데이트 필요 
Intel Joule에는 Windows IoT Core를 제대로 로드 하기 위해 펌웨어 업데이트가 필요 합니다. [여기]( https://developer.microsoft.com/en-us/windows/iot/Docs/GetStarted/joule/GetStartedStep1.htm) 에 설명 된 설치 프로세스를 따라 Joule에서 IoT Core를 사용 하세요. 
