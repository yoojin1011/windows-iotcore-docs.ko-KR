...
---
# <a name="release-notes-for-build-17686"></a>빌드 17686에 대 한 릴리스 정보
_빌드 번호 17686. 2018 년 5 월_
...
* Node.js 및 Python은 UWP 앱에서 사용할 수 없습니다. 이러한 언어의 이전 샘플은 더 이상 제대로 작동 하지 않을 수 있습니다. Microsoft는 향후 릴리스에 대 한 대안을 고려 하 고 있습니다. 
* Cortana SDK는 MBM 64, QDB의 "안녕하세요 Cortana"에 응답 하지 않습니다. 
* CortanaSDK는 웹 검색 결과를 반환 하지 않습니다. 
* 스마트 표시 앱을 설치 하는 동안 오류가 발생 했습니다. 
* MiraCast에서 동글 (QDB-> 동글을)에 연결할 수 없습니다.
* DMDashboard는 Azure 등록 후 장치 정보를 읽는 동안 예외를 throw 합니다.
* OpenSSH가 IoTCore에서 제대로 작동 하지 않습니다.
* 기어는 UWF 및 OS 업데이트에서 회전 하지 않습니다.
