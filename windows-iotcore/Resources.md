...
* [Windows AI 플랫폼을 사용 하 여 지능형에 지를 가속화 합니다.](https://www.youtube.com/watch?v=7bFAg6w4J00)
* [IoT Central Windows 10 IoT 장치 연결](https://channel9.msdn.com/Shows/Internet-of-Things-Show/Connecting-Windows-IoT-Devices-To-IoT-Central)
* [Windows 10 IoT Core 연습](https://channel9.msdn.com/Blogs/Seth-Juarez/Windows-IoT-Core-Walkthrough?term=windows%20iot%20core)
* [Windows 10 IoT 및 Azure IoT 장치 관리 기능](https://channel9.msdn.com/Shows/Azure-Friday/Windows-10-IoT-and-Azure-IoT-Device-Management-Enhancements?term=windows%20iot%20core)

## <a name="whitepapers"></a>백서
* [Azure IoT Edge + Windows IoT: 에 지에서 인공 지능을 지 원하는](https://aka.ms/IoT-Edge-WP)
* [Windows 기계 학습: Windows 앱에 AI를 구현 합니다.](https://aka.ms/Windows-ML-WP)
* [Windows IoT를 사용 하 여 더 안전한 IoT 솔루션 만들기](https://aka.ms/secure-windowsiot)
...
## <a name="commercialized-projects"></a>도 프로젝트
...
* [산업용 자동화](https://www.hackster.io/projects/tags/industrial+automation+win10)
* [디지털 간판](https://www.hackster.io/projects/tags/digital+signage+win10)
* [Healthcare](https://www.hackster.io/projects/tags/healthcare+win10)
* [스마트 건물](https://www.hackster.io/projects/tags/smart+building+win10)
...
* [전역 그래픽 소프트웨어](https://www.globalgraphics.com/)
